...
![](https://i.ibb.co/ZW8n2Rb/image.png)
...
Другой пример: на входы подаются биты `010` (т.е. десятичное положительное `2`), тогда на выходах схемы должна возникнуть комбинация `110` (т.е. десятичное отрицательное `-2`).
